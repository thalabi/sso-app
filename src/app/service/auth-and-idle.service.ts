...
export class AuthAndIdleService {
    ...
    constructor(private oauthService: OAuthService, private router: Router, private idle: Idle, private restService: RestService) { }
    ...
    getUserInfo(): Observable<UserInfo> {
        if (this.oauthService.hasValidIdToken() && this.oauthService.hasValidAccessToken()) {
            return this.restService.getUserInfo()
        } else {
